...
plt.show()
plt.savefig('part_a_cvex_hull.png')
...
plt.show()
plt.savefig('delaunay_part_a.png')
...
plt.ylabel('y')
plt.show()
plt.savefig('heatmap_partb.png', bbox_inches='tight')
...
def mesh_plus_normals(coords_3d, normals, tri):
    ...
    plt.show()
    plt.savefig('vertex_normals_plus_mesh.png', bbox_inches='tight')
...
plt.show()
plt.savefig('vertex_normals_plus_mesh.png')
